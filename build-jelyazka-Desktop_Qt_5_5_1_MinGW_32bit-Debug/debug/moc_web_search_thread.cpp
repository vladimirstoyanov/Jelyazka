/****************************************************************************
** Meta object code from reading C++ file 'web_search_thread.h'
**
...
#include "../../jelyazka/web_search_thread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'web_search_thread.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WebSearchInterfaceThread_t, stringdata0) + ofs \
...
void *WebSearchInterfaceThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WebSearchInterfaceThread.stringdata0))
