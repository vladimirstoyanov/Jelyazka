...
#include "../../jelyazka/notificationwindow.h"
...
QT_MOC_LITERAL(1, 19, 19), // "onShowAnimateWindow"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 21), // "on_animation_finished"
QT_MOC_LITERAL(4, 62, 22) // "on_animation_finished2"

    },
    "NotificationWindow\0onShowAnimateWindow\0"
    "\0on_animation_finished\0on_animation_finished2"
};
...
void NotificationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NotificationWindow *_t = static_cast<NotificationWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject NotificationWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NotificationWindow.data,
      qt_meta_data_NotificationWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NotificationWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NotificationWindow.stringdata0))
        return static_cast<void*>(const_cast< NotificationWindow*>(this));
