...
public:
    ...
    void setupUi(QWidget *NotificationWindow)
    {
        if (NotificationWindow->objectName().isEmpty())
            NotificationWindow->setObjectName(QStringLiteral("NotificationWindow"));
    ...
    {
        NotificationWindow->setWindowTitle(QApplication::translate("NotificationWindow", "Jelyazka", 0));
    } // retranslateUi
