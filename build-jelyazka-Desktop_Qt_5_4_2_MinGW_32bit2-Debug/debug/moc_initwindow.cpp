...
QT_MOC_LITERAL(3, 17, 9), // "onLoadRss"
QT_MOC_LITERAL(4, 27, 4), // "name"
QT_MOC_LITERAL(5, 32, 3) // "url"

    },
    "InitWindow\0Done\0\0onLoadRss\0name\0url"
};
...
void InitWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onLoadRss((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (InitWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InitWindow::Done)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject InitWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_InitWindow.data,
