/****************************************************************************
** Meta object code from reading C++ file 'web_search_interface.h'
**
...
#include "../../jelyazka/web_search_interface.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'web_search_interface.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WebSearchInterface_t, stringdata) + ofs \
...
void *WebSearchInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WebSearchInterface.stringdata))
