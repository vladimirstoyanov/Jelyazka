...
*/
#ifndef DOWNLOADRSSDATATHREAD_H
#define DOWNLOADRSSDATATHREAD_H
...
//ToDo: change the name to DownloadRssDataThread
class DownloadRssDataThread : public QObject, public QRunnable
{
    Q_OBJECT

public:
    DownloadRssDataThread();
    virtual ~DownloadRssDataThread();
