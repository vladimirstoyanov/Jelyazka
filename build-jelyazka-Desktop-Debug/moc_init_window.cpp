/****************************************************************************
** Meta object code from reading C++ file 'init_window.h'
**
...
#include <memory>
#include "../jelyazka/GUI/init_window.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'init_window.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 31, 18), // "onDownloadFinished"
QT_MOC_LITERAL(5, 50, 11), // "onWriteData"
QT_MOC_LITERAL(6, 62, 7), // "RSSData"
QT_MOC_LITERAL(7, 70, 8) // "rss_data"

    },
    "InitWindow\0stateChanged\0\0event\0"
...
void InitWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onWriteData((*reinterpret_cast< RSSData(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InitWindow::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InitWindow::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InitWindow::stateChanged(const QString & _t1)
{
