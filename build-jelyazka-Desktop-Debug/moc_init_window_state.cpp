...
QT_MOC_LITERAL(4, 47, 13) // "updateRssData"

    },
    "InitWindowState\0hideInitWindow\0\0"
    "showInitWindow\0updateRssData"
};
...
void InitWindowState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (InitWindowState::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InitWindowState::updateRssData)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void InitWindowState::updateRssData()
{
