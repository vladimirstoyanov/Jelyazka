...
#include <memory>
#include "../jelyazka/GUI/help_window.h"
...
void Help::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Help::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Help::stateChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Help::stateChanged(const QString & _t1)
{
