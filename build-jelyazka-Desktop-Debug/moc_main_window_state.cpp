...
QT_MOC_LITERAL(4, 47, 19) // "startRssRefreshData"

    },
    "MainWindowState\0hideMainWindow\0\0"
    "showMainWindow\0startRssRefreshData"
};
...
void MainWindowState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->startRssRefreshData(); break;
        default: ;
        }
        ...
        {
            using _t = void (MainWindowState::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindowState::startRssRefreshData)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void MainWindowState::startRssRefreshData()
{
